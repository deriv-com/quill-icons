...
export const LegacyBollingerIcon = (
  ...
  >
    ...
    <path
      fill='#85ACB0'
      d='M3.415 7.91A21.2 21.2 0 0 1 12.009 6c2.948.028 5.877.679 8.576 1.91a1 1 0 1 0 .83-1.82A23.2 23.2 0 0 0 12.009 4a23.2 23.2 0 0 0-9.424 2.09 1 1 0 0 0 .83 1.82'
    />
    <path
      fill='#FF444F'
