...
export const FlagMexicoIcon = (
  ...
  >
    ...
    <path
      fill='#783C46'
      d='M11.286 6.2a.36.36 0 0 1 .357.363.72.72 0 0 0-.131.82l.08.165c.034.068.078.13.131.184l.99 1.007v-.501c0-.625-.142-1.24-.417-1.798a1.069 1.069 0 0 0-.958-.602h-.052z'
    />
    <path
      fill='#9B4B5A'
    ...
    <path
      fill='#00C3A0'
      d='M11.822 9.826c0 .1.08.181.178.181a.18.18 0 0 0 .178-.181v-.55a2.786 2.786 0 0 0 1.728-.767.183.183 0 0 0 .009-.256.177.177 0 0 0-.252-.01A2.42 2.42 0 0 1 12 8.92c-.61 0-1.2-.24-1.663-.677a.177.177 0 0 0-.252.01.183.183 0 0 0 .01.256c.482.456 1.09.725 1.727.767z'
    />
    <path
      fill='#42A5F5'
      d='M12 10.007c-.457 0-.9-.136-1.281-.393l.197-.302a1.964 1.964 0 0 0 2.168 0l.197.302c-.38.257-.824.393-1.281.393'
    />
    <path
      fill='#66BB6A'
      d='M9.324 7.65c0 1.5 1.2 2.72 2.676 2.72 1.476 0 2.676-1.22 2.676-2.72h.357c0 1.7-1.36 3.082-3.033 3.082-1.672 0-3.033-1.382-3.033-3.081zm1.3-1.848.165.322c-.044.023-.062.089-.05.135.004.02.014.063.101.063.219 0 .427.13.494.311.03.077.073.276-.144.473-.235.213-.375.373-.297.463a.5.5 0 0 0 .143.064c.16.055.46.157.417.537-.027.239-.237.405-.522.412h-.023c-.472 0-1.038-.403-1.188-1.301l.352-.06c.125.747.577 1 .849.999.083-.002.17-.032.177-.091.008-.072.01-.089-.177-.153-.101-.035-.216-.074-.297-.168-.326-.379.116-.78.328-.972.037-.034.053-.063.049-.074-.012-.03-.082-.078-.16-.078-.227 0-.4-.13-.45-.339a.487.487 0 0 1 .234-.543'
    />
    <path
      fill='#FFA726'
