...
export const FlagBosniaAndHerzegovinaIcon = (
  ...
  >
    <path
      fill='#001C98'
      d='M22 16H2a2 2 0 0 1-2-2V2C0 1.388.275.84.709.473L23.29 15.527A1.992 1.992 0 0 1 22 16'
    />
    <path
      fill='#FC0'
      d='M2 0h20a2 2 0 0 1 2 2v12c0 .612-.275 1.16-.709 1.527L.71.473A1.992 1.992 0 0 1 2 0'
    />
    <path
      fill='#fff'
      fillRule='evenodd'
