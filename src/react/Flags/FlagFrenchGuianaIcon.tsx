...
export const FlagFrenchGuianaIcon = (
  ...
  >
    ...
    <path
      fill='#078930'
      d='M22 0H2C1.508 0 1.057.178.709.473l10.296 6.864.76-.11.734-1.489.735 1.49 1.643.237-1.19 1.16.097.564 9.507 6.338c.434-.366.709-.915.709-1.527V2a2 2 0 0 0-2-2'
    />
    <path
      fill='#FCDD09'
