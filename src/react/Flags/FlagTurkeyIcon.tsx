...
export const FlagTurkeyIcon = (
  ...
  >
    ...
    <path
      fill='#fff'
      d='M11 4c1.282 0 2.424.603 3.156 1.542a3.479 3.479 0 0 0-2.045-.653c-1.84 0-3.333 1.393-3.333 3.111 0 1.718 1.492 3.111 3.333 3.111.77 0 1.48-.244 2.045-.654A4 4 0 1 1 11 4'
    />
    <path
      fill='#000'
      fillOpacity={0.08}
