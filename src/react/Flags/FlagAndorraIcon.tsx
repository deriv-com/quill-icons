...
export const FlagAndorraIcon = (
  ...
  >
    ...
    <path
      fill='#C8B47C'
      fillRule='evenodd'
      d='M13.436 10.435A1.5 1.5 0 0 0 14.5 9V6c0-.835-.672-1.5-1.5-1.5h-2A1.5 1.5 0 0 0 9.5 6v3c0 .682.448 1.25 1.064 1.436.186.62.758 1.064 1.436 1.064.682 0 1.25-.45 1.436-1.065'
      clipRule='evenodd'
    />
