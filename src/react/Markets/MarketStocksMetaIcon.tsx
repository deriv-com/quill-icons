...
export const MarketStocksMetaIcon = (
  ...
  >
    ...
    <g clipPath='url(#d3a064354a7183924645212b7639a101__a)'>
      <path
        fill='#F2F5F8'
        d='M32 16c0 8.837-7.163 16-16 16S0 24.837 0 16 7.163 0 16 0s16 7.163 16 16'
      />
      <path
        fill='url(#d3a064354a7183924645212b7639a101__b)'
    ...
    <defs>
      <linearGradient
        id='d3a064354a7183924645212b7639a101__b'
        x1={17.572}
        x2={11.517}
        y1={12.081}
        y2={16.001}
      ...
      <clipPath id='d3a064354a7183924645212b7639a101__a'>
