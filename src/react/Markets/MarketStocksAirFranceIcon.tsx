...
export const MarketStocksAirFranceIcon = (
  ...
  >
    ...
    <g clipPath='url(#ebd6555f34063a0998966682b3d1fc36__a)'>
      <path
        fill='#F6F7F8'
        d='M32 16c0 8.837-7.163 16-16 16S0 24.837 0 16 7.163 0 16 0s16 7.163 16 16'
      />
      <path
        fill='url(#ebd6555f34063a0998966682b3d1fc36__b)'
    ...
    <defs>
      <linearGradient
        id='ebd6555f34063a0998966682b3d1fc36__b'
        x1={20.904}
        x2={20.904}
        y1={-2.903}
        y2={32.27}
      ...
      <clipPath id='ebd6555f34063a0998966682b3d1fc36__a'>
