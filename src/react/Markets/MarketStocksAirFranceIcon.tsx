...
export const MarketStocksAirFranceIcon = (
  ...
  >
    ...
    <g clipPath='url(#74648e6919b8fe6a40b5b9f5e01b5c41__a)'>
      <path
        fill='#F6F7F8'
        d='M32 16c0 8.837-7.163 16-16 16S0 24.837 0 16 7.163 0 16 0s16 7.163 16 16'
      />
      <path
        fill='url(#74648e6919b8fe6a40b5b9f5e01b5c41__b)'
    ...
    <defs>
      <linearGradient
        id='74648e6919b8fe6a40b5b9f5e01b5c41__b'
        x1={20.904}
        x2={20.904}
        y1={-2.903}
        y2={32.27}
      ...
      <clipPath id='74648e6919b8fe6a40b5b9f5e01b5c41__a'>
