...
export const MarketStocksAirFranceIcon = (
  ...
  >
    ...
    <g clipPath='url(#28f4d1bbfac1b2aef130c4ea763e3a9f__a)'>
      <path
        fill='#F6F7F8'
        d='M32 16c0 8.837-7.163 16-16 16S0 24.837 0 16 7.163 0 16 0s16 7.163 16 16'
      />
      <path
        fill='url(#28f4d1bbfac1b2aef130c4ea763e3a9f__b)'
    ...
    <defs>
      <linearGradient
        id='28f4d1bbfac1b2aef130c4ea763e3a9f__b'
        x1={20.904}
        x2={20.904}
        y1={-2.903}
        y2={32.27}
      ...
      <clipPath id='28f4d1bbfac1b2aef130c4ea763e3a9f__a'>
