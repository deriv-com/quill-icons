...
export const MarketStocksPepsicoIcon = (
  ...
  <svg
    ...
    {...props}
  >
    <g clipPath='url(#61d1277ddcceb6952418a8e954e6eabb__a)'>
      <path
        fill='#F6F7F8'
      ...
      <path
        fill='#EB7B30'
        fillRule='evenodd'
        d='M2.258 14.16a.923.923 0 0 0-.116.408c0 .346.35.666.991.666 1.235 0 2.662-.909 2.662-1.752 0-.38-.359-.585-.608-.628l-.004.015c.077.025.36.156.36.494 0 .672-1.259 1.588-2.514 1.588-.48 0-.783-.237-.783-.582 0-.11.023-.182.029-.202z'
        clipRule='evenodd'
      />
      <path
        fill='#00984A'
        fillRule='evenodd'
        d='M6.304 13.545a.655.655 0 0 1 .237.515c0 1.093-1.712 2.168-3.226 2.168-.903 0-1.315-.446-1.297-.841h.016c.036.205.329.573 1.12.573 1.515 0 3.208-1.112 3.208-2.087a.652.652 0 0 0-.071-.317z'
        clipRule='evenodd'
      />
      <path
        fill='#DF002C'
    ...
    <defs>
      <clipPath id='61d1277ddcceb6952418a8e954e6eabb__a'>
