...
export const MarketStocksAmericanAirlinesIcon = (
  ...
  >
    ...
    <defs>
      ...
      <linearGradient
        id='fa1f6e3e5aa703df0a0d2be4d69896e7__c'
        x1={16.004}
        x2={16.004}
        y1={0.579}
        y2={31.618}
      ...
      <linearGradient
        id='fa1f6e3e5aa703df0a0d2be4d69896e7__d'
        x1={693.984}
        x2={380.672}
        y1={394.88}
        y2={672.608}
      ...
      <linearGradient
        id='fa1f6e3e5aa703df0a0d2be4d69896e7__e'
        x1={14.385}
        x2={20.839}
        y1={17.365}
        y2={17.24}
      ...
      <clipPath id='fa1f6e3e5aa703df0a0d2be4d69896e7__a'>
