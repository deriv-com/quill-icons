...
export const MarketStocksProcterAndGambleIcon = (
  ...
  >
    ...
    <g clipPath='url(#f3702a34bc41916d504831f22bdc1ef8__a)'>
      <path
        fill='url(#f3702a34bc41916d504831f22bdc1ef8__b)'
        d='M18.5.194C10.85 1.394 5 8.014 5 16s5.85 14.606 13.5 15.806C26.15 30.606 32 23.986 32 16S26.15 1.394 18.5.194'
      />
      <path
        fill='url(#f3702a34bc41916d504831f22bdc1ef8__c)'
    ...
    <defs>
      <radialGradient
        id='f3702a34bc41916d504831f22bdc1ef8__c'
        cx={0}
        cy={0}
        r={1}
      ...
      <linearGradient
        id='f3702a34bc41916d504831f22bdc1ef8__b'
        x1={18.963}
        x2={18.963}
        y1={-0.197}
        y2={32.197}
      ...
      <clipPath id='f3702a34bc41916d504831f22bdc1ef8__a'>
