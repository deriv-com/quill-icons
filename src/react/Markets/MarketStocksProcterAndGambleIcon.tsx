...
export const MarketStocksProcterAndGambleIcon = (
  ...
  <svg
    ...
    {...props}
  >
    <g clipPath='url(#b97481ce1fd73fc48cefd9487fa63aee__a)'>
      <path
        fill='url(#b97481ce1fd73fc48cefd9487fa63aee__b)'
        d='M18.5.194C10.85 1.394 5 8.014 5 16s5.85 14.606 13.5 15.806C26.15 30.606 32 23.986 32 16S26.15 1.394 18.5.194'
      />
      <path
        fill='url(#b97481ce1fd73fc48cefd9487fa63aee__c)'
    ...
    <defs>
      <radialGradient
        id='b97481ce1fd73fc48cefd9487fa63aee__c'
        cx={0}
        cy={0}
        r={1}
      ...
      <linearGradient
        id='b97481ce1fd73fc48cefd9487fa63aee__b'
        x1={18.963}
        x2={18.963}
        y1={-0.197}
        y2={32.197}
      ...
      <clipPath id='b97481ce1fd73fc48cefd9487fa63aee__a'>
