...
export const MarketStocksBiogenIcon = (
  ...
  >
    ...
    <g clipPath='url(#34316f01c7837d7348684685d0a030a2__a)'>
      <path
        fill='#F6F7F8'
        d='M32 16c0 8.837-7.163 16-16 16S0 24.837 0 16 7.163 0 16 0s16 7.163 16 16'
      />
      <path
        fill='url(#34316f01c7837d7348684685d0a030a2__b)'
        d='M11.55 22.083c3.082-.984 7.551-2.873 8.36-5.031.718-1.915-2.05-6.004-4.605-9.114a8.466 8.466 0 0 0-3.754 14.145'
      />
      <path
        fill='url(#34316f01c7837d7348684685d0a030a2__c)'
      ...
      />
      <path
        fill='url(#34316f01c7837d7348684685d0a030a2__d)'
      ...
      />
      <path
        fill='url(#34316f01c7837d7348684685d0a030a2__e)'
      ...
      />
      <path
        fill='url(#34316f01c7837d7348684685d0a030a2__f)'
    ...
    <defs>
      <linearGradient
        id='34316f01c7837d7348684685d0a030a2__c'
        x1={7.499}
        x2={36.136}
        y1={34.785}
        y2={21.7}
      ...
      <linearGradient
        id='34316f01c7837d7348684685d0a030a2__d'
        x1={30.026}
        x2={15.805}
        y1={1.061}
        y2={31.681}
      ...
      <linearGradient
        id='34316f01c7837d7348684685d0a030a2__e'
        x1={26.483}
        x2={-3.242}
        y1={26.401}
        y2={6.258}
      ...
      <radialGradient
        id='34316f01c7837d7348684685d0a030a2__b'
        cx={0}
        cy={0}
        r={1}
      ...
      <radialGradient
        id='34316f01c7837d7348684685d0a030a2__f'
        cx={0}
        cy={0}
        r={1}
      ...
      <clipPath id='34316f01c7837d7348684685d0a030a2__a'>
