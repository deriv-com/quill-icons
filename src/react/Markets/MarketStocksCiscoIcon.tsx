...
export const MarketStocksCiscoIcon = (
  ...
  <svg
    ...
    {...props}
  >
    <g clipPath='url(#4fc5b67db90df897069c2924fadcf109__a)'>
      <path
        fill='#00A7E0'
      ...
      <path
        fill='#fff'
        d='M9.34 19.606a1.831 1.831 0 0 0-.886-.225 1.125 1.125 0 0 0 0 2.25c.31 0 .613-.078.885-.225v1.117a3 3 0 0 1-.96.15 2.159 2.159 0 1 1 0-4.312c.325.004.648.052.96.143zM19.44 19.381c.31 0 .614.076.885.225v-1.102a3.619 3.619 0 0 0-.96-.143 2.16 2.16 0 1 0 0 4.312c.326 0 .65-.05.96-.15v-1.117a1.867 1.867 0 0 1-.885.225 1.125 1.125 0 0 1 0-2.25M10.786 18.406h1.05v4.17h-1.05zM13.651 12.49a.524.524 0 0 0-1.042 0v2.534a.526.526 0 0 0 1.042 0zM16.364 13.564a.518.518 0 0 1 .152.365v1.095a.517.517 0 0 1-1.035 0V13.93a.517.517 0 0 1 .883-.366M19.388 12.49a.525.525 0 0 0-1.043 0v2.534a.525.525 0 0 0 1.043 0zM22.087 10.195a.524.524 0 0 1 .173.33v5.534a.525.525 0 1 1-1.043 0v-5.534a.525.525 0 0 1 .87-.33M25.132 12.49a.525.525 0 0 0-1.05 0v2.534a.525.525 0 1 0 1.05 0zM27.976 13.71c.022.071.03.146.02.22v1.094a.526.526 0 0 1-1.042 0V13.93a.525.525 0 0 1 1.022-.219M27.396 22.028v.068h-.187v.48h-.075v-.48h-.188v-.068zM27.554 22.028h-.12v.548h.075v-.45h.007l.158.45h.075l.165-.45v.45h.082v-.548h-.12l-.157.45z'
      />
    </g>
    <defs>
      <clipPath id='4fc5b67db90df897069c2924fadcf109__a'>
