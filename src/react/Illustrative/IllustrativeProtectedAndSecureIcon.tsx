  ...
  >
    <g>
      <path
        ...
        clipRule='evenodd'
      />
      <path d='M7.333 6.667a2 2 0 0 0-2 2v2a.667.667 0 1 1-1.333 0v-2a3.333 3.333 0 0 1 3.333-3.334h13.334a.667.667 0 1 1 0 1.334zM30.667 13.333a.667.667 0 0 0-1.334 0V20a2 2 0 0 1-2 2H14a.667.667 0 0 0 0 1.333h2.667v2H14a.667.667 0 0 0 0 1.334h6.667a.667.667 0 0 0 0-1.334H18v-2h9.333A3.333 3.333 0 0 0 30.667 20zM4.667 25.867a.667.667 0 0 0 0 1.333h4a.667.667 0 0 0 0-1.334z' />
      <path
        fillRule='evenodd'
