...
export const IllustrativeHighIcon = (
  ...
  >
    <g>
      ...
      <path d='m20.867 16.927-4.574-2.287a.66.66 0 0 0-.593 0l-4.573 2.287a.674.674 0 0 0-.3.893c.166.327.566.46.893.3l4.273-2.14 4.274 2.14a.671.671 0 0 0 .9-.293.66.66 0 0 0-.3-.894z' />
    </g>
  </svg>
);
