...
export const IllustrativeCloseAccountIcon = (
  ...
  >
    ...
    <g>
      <path d='M9.333 23.333c1.654 0 3-1.346 3-3s-1.346-3-3-3-3 1.347-3 3 1.347 3 3 3m0-4.666a1.667 1.667 0 1 1 0 3.334 1.667 1.667 0 0 1 0-3.334M15.333 20h6c.367 0 .667-.3.667-.667 0-.366-.3-.666-.667-.666h-6c-.366 0-.666.3-.666.666s.3.667.666.667M15.333 22.667H20c.367 0 .667-.3.667-.667s-.3-.667-.667-.667h-4.667c-.366 0-.666.3-.666.667s.3.667.666.667' />
