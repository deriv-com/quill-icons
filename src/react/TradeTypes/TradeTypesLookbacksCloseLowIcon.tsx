...
export const TradeTypesLookbacksCloseLowIcon = (
  ...
  >
    ...
    <path fill='#85ACB0' d='M26.667 24v2.667H5.334V24zM25.333 5.333v17.334h-2.666V5.333z' />
    <path
      fill='#FF444F'
...
const ForwardRef = forwardRef(TradeTypesLookbacksCloseLowIcon);
