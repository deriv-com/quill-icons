...
const PaymentMethodOzowBrandIcon = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  ...
  >
    ...
    />
    <path
      fill='url(#972f55bcf469fafbae393093d45bd4a7__a)'
    ...
    />
    <path
      fill='url(#972f55bcf469fafbae393093d45bd4a7__b)'
    ...
    />
    <path
      fill='url(#972f55bcf469fafbae393093d45bd4a7__c)'
    ...
    />
    <path
      fill='url(#972f55bcf469fafbae393093d45bd4a7__d)'
    ...
    <defs>
      <linearGradient
        id='972f55bcf469fafbae393093d45bd4a7__a'
        x1={14.248}
        x2={55.5}
        y1={12.879}
        y2={108.002}
      ...
      <linearGradient
        id='972f55bcf469fafbae393093d45bd4a7__b'
        x1={-107.291}
        x2={-67.519}
        y1={-13.571}
        y2={149.541}
      ...
      <linearGradient
        id='972f55bcf469fafbae393093d45bd4a7__c'
        x1={1.348}
        x2={37.354}
        y1={14.13}
        y2={123.85}
      ...
      <linearGradient
        id='972f55bcf469fafbae393093d45bd4a7__d'
        x1={3.591}
        x2={30.823}
        y1={24.853}
        y2={55.694}
