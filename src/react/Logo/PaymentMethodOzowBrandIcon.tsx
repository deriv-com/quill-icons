...
const PaymentMethodOzowBrandIcon = (
  ...
  >
    ...
    />
    <path
      fill='url(#ce5b26a68a97090093e4ee9e8ef2f7b2__a)'
    ...
    />
    <path
      fill='url(#ce5b26a68a97090093e4ee9e8ef2f7b2__b)'
    ...
    />
    <path
      fill='url(#ce5b26a68a97090093e4ee9e8ef2f7b2__c)'
    ...
    />
    <path
      fill='url(#ce5b26a68a97090093e4ee9e8ef2f7b2__d)'
    ...
    <defs>
      <linearGradient
        id='ce5b26a68a97090093e4ee9e8ef2f7b2__a'
        x1={14.248}
        x2={55.5}
        y1={12.879}
        y2={108.002}
      ...
      <linearGradient
        id='ce5b26a68a97090093e4ee9e8ef2f7b2__b'
        x1={-107.291}
        x2={-67.519}
        y1={-13.571}
        y2={149.541}
      ...
      <linearGradient
        id='ce5b26a68a97090093e4ee9e8ef2f7b2__c'
        x1={1.348}
        x2={37.354}
        y1={14.13}
        y2={123.85}
      ...
      <linearGradient
        id='ce5b26a68a97090093e4ee9e8ef2f7b2__d'
        x1={3.591}
        x2={30.823}
        y1={24.853}
        y2={55.694}
