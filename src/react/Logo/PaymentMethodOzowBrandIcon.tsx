...
const PaymentMethodOzowBrandIcon = (
  ...
  >
    ...
    />
    <path
      fill='url(#1eabc090622e8d2e3015606be38fe8a4__a)'
    ...
    />
    <path
      fill='url(#1eabc090622e8d2e3015606be38fe8a4__b)'
    ...
    />
    <path
      fill='url(#1eabc090622e8d2e3015606be38fe8a4__c)'
    ...
    />
    <path
      fill='url(#1eabc090622e8d2e3015606be38fe8a4__d)'
    ...
    <defs>
      <linearGradient
        id='1eabc090622e8d2e3015606be38fe8a4__a'
        x1={14.248}
        x2={55.5}
        y1={12.879}
        y2={108.002}
      ...
      <linearGradient
        id='1eabc090622e8d2e3015606be38fe8a4__b'
        x1={-107.291}
        x2={-67.519}
        y1={-13.571}
        y2={149.541}
      ...
      <linearGradient
        id='1eabc090622e8d2e3015606be38fe8a4__c'
        x1={1.348}
        x2={37.354}
        y1={14.13}
        y2={123.85}
      ...
      <linearGradient
        id='1eabc090622e8d2e3015606be38fe8a4__d'
        x1={3.591}
        x2={30.823}
        y1={24.853}
        y2={55.694}
