...
const PaymentMethodLocalVouchersBrandIcon = (
  ...
  >
    ...
    <path
      fill='#79A73A'
      d='M59.02 58.499a7.177 7.177 0 1 0 0-14.354 7.177 7.177 0 0 0 0 14.354M43.231 52.757a1.435 1.435 0 1 0 0-2.87 1.435 1.435 0 0 0 0 2.87M74.81 52.757a1.435 1.435 0 1 0 0-2.87 1.435 1.435 0 0 0 0 2.87'
    />
  </svg>
);
