...
const DerivProductDerivXBrandDarkLogoIcon = (
  ...
  >
    ...
    <defs>
      <clipPath id='f14fda665971f14da092d74952f2ffcf__a'>
        <path fill='#fff' d='M0 0h72v72H0z' />
      </clipPath>
    </defs>
  </svg>
);
const ForwardRef = forwardRef(DerivProductDerivXBrandDarkLogoIcon);
