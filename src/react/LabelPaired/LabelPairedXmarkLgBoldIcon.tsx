...
const LabelPairedXmarkLgBoldIcon = (props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
  ...
  >
    <g clipPath='url(#a)'>
      <path
        fillOpacity={0.72}
        d='M13.477 10.852 8.828 15.5l4.649 4.648c.364.443.364.886 0 1.329-.443.364-.886.364-1.329 0L7.5 16.828l-4.648 4.649c-.443.364-.886.364-1.329 0-.364-.443-.364-.886 0-1.329L6.172 15.5l-4.649-4.648c-.364-.443-.364-.886 0-1.329.443-.364.886-.364 1.329 0L7.5 14.172l4.648-4.649c.443-.364.886-.364 1.329 0 .364.443.364.886 0 1.329Z'
      />
    </g>
    <defs>
      <clipPath id='a'>
