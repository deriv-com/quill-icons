...
const LabelPairedCircleXmarkMdRegularIcon = (
  ...
  >
    ...
    <g>
      <path d='M8 5a7.2 7.2 0 0 0-3.5.938A7.2 7.2 0 0 0 1.938 8.5a7 7 0 0 0 0 7A7.2 7.2 0 0 0 4.5 18.063 7.2 7.2 0 0 0 8 19a7.2 7.2 0 0 0 3.5-.937 7.2 7.2 0 0 0 2.563-2.563 7 7 0 0 0 0-7A7.2 7.2 0 0 0 11.5 5.938 7.2 7.2 0 0 0 8 5m0 15q-2.187-.03-4-1.062Q2.188 17.875 1.063 16 0 14.095 0 12t1.063-4Q2.188 6.124 4 5.063 5.813 4.03 8 4q2.188.03 4 1.063Q13.813 6.125 14.938 8 16 9.906 16 12t-1.062 4Q13.813 17.875 12 18.938 10.188 19.968 8 20M5.656 9.656q.345-.312.688 0L8 11.281l1.656-1.625q.345-.312.688 0 .312.345 0 .688L8.719 12l1.625 1.656q.312.345 0 .688-.345.312-.688 0L8 12.719l-1.656 1.625q-.345.312-.688 0-.312-.345 0-.688L7.281 12l-1.625-1.656q-.312-.345 0-.688' />
    </g>
    <defs>
      <clipPath id='f114aa54a0ed484dda9331fb455af283__a'>
