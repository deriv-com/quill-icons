...
const LabelPairedArrowRightArrowLeftXlBoldIcon = (
  ...
  >
    <g clipPath='url(#a)'>
      <path
        fillOpacity={0.72}
        d='m4.828 29.297-4.5-4.5c-.437-.531-.437-1.063 0-1.594l4.5-4.5c.531-.437 1.063-.437 1.594 0 .437.531.437 1.063 0 1.594l-2.578 2.578h16.031c.688.063 1.063.438 1.125 1.125-.063.688-.438 1.063-1.125 1.125H3.844l2.578 2.578c.437.531.437 1.063 0 1.594-.531.437-1.063.437-1.594 0Zm15.844-16.5-4.5 4.5c-.531.437-1.063.437-1.594 0-.437-.531-.437-1.063 0-1.594l2.578-2.578H1.125C.437 13.062.062 12.687 0 12c.063-.688.438-1.063 1.125-1.125h16.031l-2.578-2.578c-.437-.531-.437-1.063 0-1.594.531-.437 1.063-.437 1.594 0l4.5 4.5c.437.531.437 1.063 0 1.594Z'
      />
    </g>
    <defs>
      <clipPath id='a'>
