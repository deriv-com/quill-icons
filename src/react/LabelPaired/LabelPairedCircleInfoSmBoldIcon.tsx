...
const LabelPairedCircleInfoSmBoldIcon = (
  ...
  >
    ...
    <g>
      <path d='M7 5.063q-1.56 0-2.844.765a5.7 5.7 0 0 0-2.078 2.078 5.64 5.64 0 0 0-.765 2.844q0 1.504.765 2.844a5.7 5.7 0 0 0 2.078 2.078q1.286.765 2.844.765 1.56 0 2.844-.765 1.286-.738 2.078-2.078.765-1.34.765-2.844t-.765-2.844q-.794-1.34-2.078-2.078A5.45 5.45 0 0 0 7 5.062M7 17.75q-1.914-.027-3.5-.93-1.586-.93-2.57-2.57Q0 12.582 0 10.75t.93-3.5q.984-1.64 2.57-2.57 1.586-.903 3.5-.93 1.914.027 3.5.93 1.586.93 2.57 2.57.93 1.668.93 3.5t-.93 3.5q-.984 1.64-2.57 2.57-1.586.903-3.5.93m-1.094-4.812h.657v-1.75h-.657q-.601-.056-.656-.657.054-.601.656-.656H7.22q.601.054.656.656v2.406h.219q.601.056.656.657-.054.601-.656.656H5.906q-.601-.055-.656-.656.054-.602.656-.656M7 9a.85.85 0 0 1-.629-.246.85.85 0 0 1-.246-.629q0-.383.246-.629A.85.85 0 0 1 7 7.25q.383 0 .629.246a.85.85 0 0 1 .246.629.85.85 0 0 1-.246.629A.85.85 0 0 1 7 9' />
    </g>
    <defs>
      <clipPath id='c76f5a1fdf0e748c4cdabffedf649dd7__a'>
