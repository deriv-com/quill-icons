...
export const SocialWhatsappBrandIcon = (
  ...
  >
    ...
    <g filter='url(#070d6f3cf4193babe502758201d9ef31__a)'>
      <path
        fill='url(#070d6f3cf4193babe502758201d9ef31__b)'
      ...
      />
      <path
        fill='url(#070d6f3cf4193babe502758201d9ef31__c)'
    ...
    <defs>
      <linearGradient
        id='070d6f3cf4193babe502758201d9ef31__b'
        x1={20}
        x2={20}
        y1={34.664}
        y2={2.665}
      ...
      <linearGradient
        id='070d6f3cf4193babe502758201d9ef31__c'
        x1={20}
        x2={20}
        y1={34.8}
        y2={2.658}
      ...
      <filter
        id='070d6f3cf4193babe502758201d9ef31__a'
        width={40}
        height={40}
        x={0}
        y={0}
