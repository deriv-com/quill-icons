...
export const SocialWhatsappBrandIcon = (
  ...
  <svg
    ...
    {...props}
  >
    <g filter='url(#cd02e5a08a5b486f3e2eb062f2bd9741__a)'>
      <path
        fill='url(#cd02e5a08a5b486f3e2eb062f2bd9741__b)'
      ...
      />
      <path
        fill='url(#cd02e5a08a5b486f3e2eb062f2bd9741__c)'
    ...
    <defs>
      <linearGradient
        id='cd02e5a08a5b486f3e2eb062f2bd9741__b'
        x1={20}
        x2={20}
        y1={34.664}
        y2={2.665}
      ...
      <linearGradient
        id='cd02e5a08a5b486f3e2eb062f2bd9741__c'
        x1={20}
        x2={20}
        y1={34.8}
        y2={2.658}
      ...
      <filter
        id='cd02e5a08a5b486f3e2eb062f2bd9741__a'
        width={40}
        height={40}
        x={0}
        y={0}
