...
export const SocialWhatsappBrandIcon = (
  ...
  >
    ...
    <g filter='url(#69409b7abced833d0d8db9e129ab7ea7__a)'>
      <path
        fill='url(#69409b7abced833d0d8db9e129ab7ea7__b)'
      ...
      />
      <path
        fill='url(#69409b7abced833d0d8db9e129ab7ea7__c)'
    ...
    <defs>
      <linearGradient
        id='69409b7abced833d0d8db9e129ab7ea7__b'
        x1={20}
        x2={20}
        y1={34.664}
        y2={2.665}
      ...
      <linearGradient
        id='69409b7abced833d0d8db9e129ab7ea7__c'
        x1={20}
        x2={20}
        y1={34.8}
        y2={2.658}
      ...
      <filter
        id='69409b7abced833d0d8db9e129ab7ea7__a'
        width={40}
        height={40}
        x={0}
        y={0}
