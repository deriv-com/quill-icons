...
export const SocialWhatsappBrandIcon = (
  ...
  >
    ...
    <g filter='url(#0629aa79152551efa67e2ff5aa8db7a3__a)'>
      <path
        fill='url(#0629aa79152551efa67e2ff5aa8db7a3__b)'
      ...
      />
      <path
        fill='url(#0629aa79152551efa67e2ff5aa8db7a3__c)'
    ...
    <defs>
      <linearGradient
        id='0629aa79152551efa67e2ff5aa8db7a3__b'
        x1={20}
        x2={20}
        y1={34.664}
        y2={2.665}
      ...
      <linearGradient
        id='0629aa79152551efa67e2ff5aa8db7a3__c'
        x1={20}
        x2={20}
        y1={34.8}
        y2={2.658}
      ...
      <filter
        id='0629aa79152551efa67e2ff5aa8db7a3__a'
        width={40}
        height={40}
        x={0}
        y={0}
