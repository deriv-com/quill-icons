...
export const SocialWhatsappBrandIcon = (
  ...
  >
    ...
    <g filter='url(#6e26a4661d9bf3ecef9e6ed7e0e88170__a)'>
      <path
        fill='url(#6e26a4661d9bf3ecef9e6ed7e0e88170__b)'
      ...
      />
      <path
        fill='url(#6e26a4661d9bf3ecef9e6ed7e0e88170__c)'
    ...
    <defs>
      <linearGradient
        id='6e26a4661d9bf3ecef9e6ed7e0e88170__b'
        x1={20}
        x2={20}
        y1={34.664}
        y2={2.665}
      ...
      <linearGradient
        id='6e26a4661d9bf3ecef9e6ed7e0e88170__c'
        x1={20}
        x2={20}
        y1={34.8}
        y2={2.658}
      ...
      <filter
        id='6e26a4661d9bf3ecef9e6ed7e0e88170__a'
        width={40}
        height={40}
        x={0}
        y={0}
