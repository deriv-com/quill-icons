...
export const SocialWhatsappBrandIcon = (
  ...
  >
    ...
    <g filter='url(#725267e7a01de372677a55ae6e72c703__a)'>
      <path
        fill='url(#725267e7a01de372677a55ae6e72c703__b)'
      ...
      />
      <path
        fill='url(#725267e7a01de372677a55ae6e72c703__c)'
    ...
    <defs>
      <linearGradient
        id='725267e7a01de372677a55ae6e72c703__b'
        x1={20}
        x2={20}
        y1={34.664}
        y2={2.665}
      ...
      <linearGradient
        id='725267e7a01de372677a55ae6e72c703__c'
        x1={20}
        x2={20}
        y1={34.8}
        y2={2.658}
      ...
      <filter
        id='725267e7a01de372677a55ae6e72c703__a'
        width={40}
        height={40}
        x={0}
        y={0}
