...
export const SocialWhatsappBrandIcon = (
  ...
  >
    ...
    <g filter='url(#28f86158520ac384f117956808dec199__a)'>
      <path
        fill='url(#28f86158520ac384f117956808dec199__b)'
      ...
      />
      <path
        fill='url(#28f86158520ac384f117956808dec199__c)'
    ...
    <defs>
      <linearGradient
        id='28f86158520ac384f117956808dec199__b'
        x1={20}
        x2={20}
        y1={34.664}
        y2={2.665}
      ...
      <linearGradient
        id='28f86158520ac384f117956808dec199__c'
        x1={20}
        x2={20}
        y1={34.8}
        y2={2.658}
      ...
      <filter
        id='28f86158520ac384f117956808dec199__a'
        width={40}
        height={40}
        x={0}
        y={0}
