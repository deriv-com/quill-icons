...
export const SocialWhatsappBrandIcon = (
  ...
  >
    ...
    <g filter='url(#12db6fcb700d3e0ee3b381bdfd5ec07f__a)'>
      <path
        fill='url(#12db6fcb700d3e0ee3b381bdfd5ec07f__b)'
      ...
      />
      <path
        fill='url(#12db6fcb700d3e0ee3b381bdfd5ec07f__c)'
    ...
    <defs>
      <linearGradient
        id='12db6fcb700d3e0ee3b381bdfd5ec07f__b'
        x1={20}
        x2={20}
        y1={34.664}
        y2={2.665}
      ...
      <linearGradient
        id='12db6fcb700d3e0ee3b381bdfd5ec07f__c'
        x1={20}
        x2={20}
        y1={34.8}
        y2={2.658}
      ...
      <filter
        id='12db6fcb700d3e0ee3b381bdfd5ec07f__a'
        width={40}
        height={40}
        x={0}
        y={0}
