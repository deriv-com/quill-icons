...
export const SocialWhatsappBrandIcon = (
  ...
  >
    ...
    <g filter='url(#b509974902835e72ea2a4ac9db8725b1__a)'>
      <path
        fill='url(#b509974902835e72ea2a4ac9db8725b1__b)'
      ...
      />
      <path
        fill='url(#b509974902835e72ea2a4ac9db8725b1__c)'
    ...
    <defs>
      <linearGradient
        id='b509974902835e72ea2a4ac9db8725b1__b'
        x1={20}
        x2={20}
        y1={34.664}
        y2={2.665}
      ...
      <linearGradient
        id='b509974902835e72ea2a4ac9db8725b1__c'
        x1={20}
        x2={20}
        y1={34.8}
        y2={2.658}
      ...
      <filter
        id='b509974902835e72ea2a4ac9db8725b1__a'
        width={40}
        height={40}
        x={0}
        y={0}
