...
export const SocialWhatsappBrandIcon = (
  ...
  >
    ...
    <g filter='url(#7e7ae4df561d7c9ecc8df947ef083fec__a)'>
      <path
        fill='url(#7e7ae4df561d7c9ecc8df947ef083fec__b)'
      ...
      />
      <path
        fill='url(#7e7ae4df561d7c9ecc8df947ef083fec__c)'
    ...
    <defs>
      <linearGradient
        id='7e7ae4df561d7c9ecc8df947ef083fec__b'
        x1={20}
        x2={20}
        y1={34.664}
        y2={2.665}
      ...
      <linearGradient
        id='7e7ae4df561d7c9ecc8df947ef083fec__c'
        x1={20}
        x2={20}
        y1={34.8}
        y2={2.658}
      ...
      <filter
        id='7e7ae4df561d7c9ecc8df947ef083fec__a'
        width={40}
        height={40}
        x={0}
        y={0}
