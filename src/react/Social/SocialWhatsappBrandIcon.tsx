...
export const SocialWhatsappBrandIcon = (
  ...
  >
    ...
    <g filter='url(#3f2e4e1b108a144ed75e9b7fd704f035__a)'>
      <path
        fill='url(#3f2e4e1b108a144ed75e9b7fd704f035__b)'
      ...
      />
      <path
        fill='url(#3f2e4e1b108a144ed75e9b7fd704f035__c)'
    ...
    <defs>
      <linearGradient
        id='3f2e4e1b108a144ed75e9b7fd704f035__b'
        x1={20}
        x2={20}
        y1={34.664}
        y2={2.665}
      ...
      <linearGradient
        id='3f2e4e1b108a144ed75e9b7fd704f035__c'
        x1={20}
        x2={20}
        y1={34.8}
        y2={2.658}
      ...
      <filter
        id='3f2e4e1b108a144ed75e9b7fd704f035__a'
        width={40}
        height={40}
        x={0}
        y={0}
