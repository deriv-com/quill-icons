...
export const SocialWhatsappBrandIcon = (
  ...
  >
    ...
    <g filter='url(#770b7ce10026836f9dfbeae4d0f1b062__a)'>
      <path
        fill='url(#770b7ce10026836f9dfbeae4d0f1b062__b)'
      ...
      />
      <path
        fill='url(#770b7ce10026836f9dfbeae4d0f1b062__c)'
    ...
    <defs>
      <linearGradient
        id='770b7ce10026836f9dfbeae4d0f1b062__b'
        x1={20}
        x2={20}
        y1={34.664}
        y2={2.665}
      ...
      <linearGradient
        id='770b7ce10026836f9dfbeae4d0f1b062__c'
        x1={20}
        x2={20}
        y1={34.8}
        y2={2.658}
      ...
      <filter
        id='770b7ce10026836f9dfbeae4d0f1b062__a'
        width={40}
        height={40}
        x={0}
        y={0}
