...
export const CurrencyMaticIcon = (
  ...
  <svg
    ...
    {...props}
  >
    <g clipPath='url(#35f12dea02bbf475c9cee74c7673e7ac__a)'>
      <path
        fill='#8247E5'
