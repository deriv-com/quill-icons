...
export const StandaloneEllipsisVerticalBoldIcon = (
  ...
  <svg
    ...
    {...props}
  >
    <path d='M16 20.875c.703.026 1.25.338 1.64.938.313.625.313 1.25 0 1.875-.39.599-.937.911-1.64.937-.703-.026-1.25-.338-1.64-.937-.313-.625-.313-1.25 0-1.875.39-.6.937-.912 1.64-.938m0-6.25c.703.026 1.25.338 1.64.938.313.624.313 1.25 0 1.874-.39.6-.937.912-1.64.938-.703-.026-1.25-.338-1.64-.937-.313-.625-.313-1.25 0-1.875.39-.6.937-.912 1.64-.938m1.875-4.375c-.026.703-.338 1.25-.937 1.64-.625.313-1.25.313-1.875 0-.6-.39-.912-.937-.938-1.64.026-.703.338-1.25.938-1.64.624-.313 1.25-.313 1.874 0 .6.39.912.937.938 1.64' />
  </svg>
);
