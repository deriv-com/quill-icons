...
const DerivLightOrderIcon = (
  ...
  >
    ...
    <g clipPath='url(#4cd588af4f747170d9052f050471b6fd__a)'>
      <mask
        id='4cd588af4f747170d9052f050471b6fd__b'
        width={128}
        height={128}
        x={0}
        y={0}
      ...
      <g mask='url(#4cd588af4f747170d9052f050471b6fd__b)'>
        <path
          fill='#C7E5E5'
    ...
    <defs>
      <clipPath id='4cd588af4f747170d9052f050471b6fd__a'>
