...
const DerivLightOrderIcon = (
  ...
  >
    ...
    <g clipPath='url(#65103be78a7849ff90d1a98c776a3e6e__a)'>
      <mask
        id='65103be78a7849ff90d1a98c776a3e6e__b'
        width={128}
        height={128}
        x={0}
        y={0}
      ...
      <g mask='url(#65103be78a7849ff90d1a98c776a3e6e__b)'>
        <path
          fill='#C7E5E5'
    ...
    <defs>
      <clipPath id='65103be78a7849ff90d1a98c776a3e6e__a'>
