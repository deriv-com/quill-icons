...
const DerivLightOrderIcon = (
  ...
  >
    ...
    <g clipPath='url(#2e6659f63ed08547eebffa4d0a4d71fe__a)'>
      <mask
        id='2e6659f63ed08547eebffa4d0a4d71fe__b'
        width={128}
        height={128}
        x={0}
        y={0}
      ...
      <g mask='url(#2e6659f63ed08547eebffa4d0a4d71fe__b)'>
        <path
          fill='#C7E5E5'
    ...
    <defs>
      <clipPath id='2e6659f63ed08547eebffa4d0a4d71fe__a'>
