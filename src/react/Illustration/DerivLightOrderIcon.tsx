...
const DerivLightOrderIcon = (
  ...
  >
    ...
    <g clipPath='url(#1cd0f50db883225d05083349bc369392__a)'>
      <mask
        id='1cd0f50db883225d05083349bc369392__b'
        width={128}
        height={128}
        x={0}
        y={0}
      ...
      <g mask='url(#1cd0f50db883225d05083349bc369392__b)'>
        <path
          fill='#C7E5E5'
    ...
    <defs>
      <clipPath id='1cd0f50db883225d05083349bc369392__a'>
