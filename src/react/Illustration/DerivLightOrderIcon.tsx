...
const DerivLightOrderIcon = (
  ...
  >
    ...
    <g clipPath='url(#645001170748e4bf026246cbe4e1ff1f__a)'>
      <mask
        id='645001170748e4bf026246cbe4e1ff1f__b'
        width={128}
        height={128}
        x={0}
        y={0}
      ...
      <g mask='url(#645001170748e4bf026246cbe4e1ff1f__b)'>
        <path
          fill='#C7E5E5'
    ...
    <defs>
      <clipPath id='645001170748e4bf026246cbe4e1ff1f__a'>
