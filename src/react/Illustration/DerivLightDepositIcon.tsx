...
const DerivLightDepositIcon = (
  ...
  >
    ...
    <g clipPath='url(#1e04b095822ffd8b2d6e032915ccc776__a)'>
      <mask
        id='1e04b095822ffd8b2d6e032915ccc776__b'
        width={32}
        height={32}
        x={0}
        y={0}
      ...
      <g mask='url(#1e04b095822ffd8b2d6e032915ccc776__b)'>
        <path
          fill='#85ACB0'
    ...
    <defs>
      <clipPath id='1e04b095822ffd8b2d6e032915ccc776__a'>
