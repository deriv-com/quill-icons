...
const DerivLightDepositIcon = (
  ...
  >
    ...
    <g clipPath='url(#b8e604707662391c3f17c90ea67e3a64__a)'>
      <mask
        id='b8e604707662391c3f17c90ea67e3a64__b'
        width={32}
        height={32}
        x={0}
        y={0}
      ...
      <g mask='url(#b8e604707662391c3f17c90ea67e3a64__b)'>
        <path
          fill='#85ACB0'
          d='m15.175 1.14 11.818 2.084a2 2 0 0 1 1.622 2.317l-2.257 12.802L10.6 15.565l2.257-12.802a2 2 0 0 1 2.317-1.623'
        />
        <path
          fill='#fff'
    ...
    <defs>
      <clipPath id='b8e604707662391c3f17c90ea67e3a64__a'>
