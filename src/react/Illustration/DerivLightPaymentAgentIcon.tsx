...
const DerivLightPaymentAgentIcon = (
  ...
  >
    ...
    <g clipPath='url(#b67027d4fe54350a525131c12885ac23__a)'>
      <mask
        id='b67027d4fe54350a525131c12885ac23__b'
        width={32}
        height={32}
        x={0}
        y={0}
      ...
      <g mask='url(#b67027d4fe54350a525131c12885ac23__b)'>
        <path
          fill='#C7E5E5'
    ...
    <defs>
      <clipPath id='b67027d4fe54350a525131c12885ac23__a'>
