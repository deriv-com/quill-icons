...
const DerivLightMobileVerifiedIcon = (
  ...
  >
    ...
    <g clipPath='url(#ca4a4237881bbc7597d6ef1b1fdfefbc__a)'>
      <mask
        id='ca4a4237881bbc7597d6ef1b1fdfefbc__b'
        width={128}
        height={128}
        x={0}
        y={0}
      ...
      <g mask='url(#ca4a4237881bbc7597d6ef1b1fdfefbc__b)'>
        <path
          fill='#E0F0F0'
    ...
    <defs>
      <clipPath id='ca4a4237881bbc7597d6ef1b1fdfefbc__a'>
