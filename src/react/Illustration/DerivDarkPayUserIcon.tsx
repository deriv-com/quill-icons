...
const DerivDarkPayUserIcon = (
  ...
  >
    ...
    <g clipPath='url(#3ccd19bd2e82ed6e82095940706d0737__a)'>
      <mask
        id='3ccd19bd2e82ed6e82095940706d0737__b'
        width={96}
        height={96}
        x={0}
        y={0}
      ...
      <g mask='url(#3ccd19bd2e82ed6e82095940706d0737__b)'>
        <path
          fill='#EBECEF'
    ...
    <defs>
      <clipPath id='3ccd19bd2e82ed6e82095940706d0737__a'>
