...
const DerivDarkPayUserIcon = (
  ...
  >
    ...
    <g clipPath='url(#932679a9db701893bef2e87a47cbcb0b__a)'>
      <mask
        id='932679a9db701893bef2e87a47cbcb0b__b'
        width={96}
        height={96}
        x={0}
        y={0}
      ...
      <g mask='url(#932679a9db701893bef2e87a47cbcb0b__b)'>
        <path
          fill='#EBECEF'
    ...
    <defs>
      <clipPath id='932679a9db701893bef2e87a47cbcb0b__a'>
