...
const DerivDarkPayUserIcon = (
  ...
  >
    ...
    <g clipPath='url(#a929bec757eba1d0a2e5a13d5e6f827b__a)'>
      <mask
        id='a929bec757eba1d0a2e5a13d5e6f827b__b'
        width={96}
        height={96}
        x={0}
        y={0}
      ...
      <g mask='url(#a929bec757eba1d0a2e5a13d5e6f827b__b)'>
        <path
          fill='#EBECEF'
    ...
    <defs>
      <clipPath id='a929bec757eba1d0a2e5a13d5e6f827b__a'>
