...
const DerivDarkPayUserIcon = (
  ...
  >
    ...
    <g clipPath='url(#1a9b4efb64f4f1741383ea92b2e5a2d5__a)'>
      <mask
        id='1a9b4efb64f4f1741383ea92b2e5a2d5__b'
        width={96}
        height={96}
        x={0}
        y={0}
      ...
      <g mask='url(#1a9b4efb64f4f1741383ea92b2e5a2d5__b)'>
        <path
          fill='#EBECEF'
    ...
    <defs>
      <clipPath id='1a9b4efb64f4f1741383ea92b2e5a2d5__a'>
