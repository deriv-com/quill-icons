...
const DerivLightIcWrongEmailPasskeyIcon = (
  ...
  >
    ...
    <g clipPath='url(#585243d3a6a9407297a62353db2fafad__a)'>
      <path
        fill='url(#585243d3a6a9407297a62353db2fafad__b)'
        fillRule='evenodd'
    ...
    <defs>
      <linearGradient
        id='585243d3a6a9407297a62353db2fafad__b'
        x1={16}
        x2={47.504}
        y1={47.262}
        y2={15.266}
      ...
      <clipPath id='585243d3a6a9407297a62353db2fafad__a'>
