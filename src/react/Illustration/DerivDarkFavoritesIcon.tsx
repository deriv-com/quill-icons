...
const DerivDarkFavoritesIcon = (
  ...
  >
    ...
    <g clipPath='url(#fe546b1a1b0e4bd21eb862b0017fdece__a)'>
      <path
        fill='#151717'
      ...
      <mask
        id='fe546b1a1b0e4bd21eb862b0017fdece__b'
        width={24}
        height={24}
        x={216}
        y={56}
      ...
      <g mask='url(#fe546b1a1b0e4bd21eb862b0017fdece__b)'>
        <path
          fill='#fff'
    ...
    <defs>
      <clipPath id='fe546b1a1b0e4bd21eb862b0017fdece__a'>
