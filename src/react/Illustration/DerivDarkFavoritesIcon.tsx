...
const DerivDarkFavoritesIcon = (
  ...
  >
    ...
    <g clipPath='url(#ef9bff870192998e8b76867b02bd621d__a)'>
      <path
        fill='#151717'
      ...
      <mask
        id='ef9bff870192998e8b76867b02bd621d__b'
        width={24}
        height={24}
        x={216}
        y={56}
      ...
      <g mask='url(#ef9bff870192998e8b76867b02bd621d__b)'>
        <path
          fill='#fff'
    ...
    <defs>
      <clipPath id='ef9bff870192998e8b76867b02bd621d__a'>
