...
const DerivDarkFavoritesIcon = (
  ...
  >
    ...
    <g clipPath='url(#e3dab13870330724f447253d93453ac6__a)'>
      <path
        fill='#151717'
      ...
      <mask
        id='e3dab13870330724f447253d93453ac6__b'
        width={24}
        height={24}
        x={216}
        y={56}
      ...
      <g mask='url(#e3dab13870330724f447253d93453ac6__b)'>
        <path
          fill='#fff'
    ...
    <defs>
      <clipPath id='e3dab13870330724f447253d93453ac6__a'>
