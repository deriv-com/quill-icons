...
const DerivLightIcEmailVerificationLinkBlockedIcon = (
  ...
  >
    ...
    <g clipPath='url(#3db6e4d398435808885e486b61fa7ab6__a)'>
      <mask
        id='3db6e4d398435808885e486b61fa7ab6__b'
        width={129}
        height={128}
        x={0}
        y={0}
      ...
      <g mask='url(#3db6e4d398435808885e486b61fa7ab6__b)'>
        <path
          fill='#BBCCCE'
    ...
    <defs>
      <clipPath id='3db6e4d398435808885e486b61fa7ab6__a'>
