...
const DerivLightIcEmailVerificationLinkBlockedIcon = (
  ...
  >
    ...
    <g clipPath='url(#9db08f054d5cdb3368fe4bbe73fa5796__a)'>
      <mask
        id='9db08f054d5cdb3368fe4bbe73fa5796__b'
        width={129}
        height={128}
        x={0}
        y={0}
      ...
      <g mask='url(#9db08f054d5cdb3368fe4bbe73fa5796__b)'>
        <path
          fill='#BBCCCE'
    ...
    <defs>
      <clipPath id='9db08f054d5cdb3368fe4bbe73fa5796__a'>
