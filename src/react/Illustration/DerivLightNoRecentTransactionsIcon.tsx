...
const DerivLightNoRecentTransactionsIcon = (
  ...
  >
    ...
    <g clipPath='url(#fe337bcb09232910a9aed11549a6d2d0__a)'>
      <path
        fill='url(#fe337bcb09232910a9aed11549a6d2d0__b)'
        d='M64 128c35.346 0 64-28.654 64-64S99.346 0 64 0 0 28.654 0 64s28.654 64 64 64'
      />
      <path
        fill='url(#fe337bcb09232910a9aed11549a6d2d0__c)'
    ...
    <defs>
      <linearGradient
        id='fe337bcb09232910a9aed11549a6d2d0__b'
        x1={64}
        x2={64}
        y1={128}
        y2={0}
      ...
      <linearGradient
        id='fe337bcb09232910a9aed11549a6d2d0__c'
        x1={63.992}
        x2={64.003}
        y1={0}
        y2={128}
      ...
      <clipPath id='fe337bcb09232910a9aed11549a6d2d0__a'>
