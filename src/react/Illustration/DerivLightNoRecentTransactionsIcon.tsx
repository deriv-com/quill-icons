...
const DerivLightNoRecentTransactionsIcon = (
  ...
  >
    ...
    <g clipPath='url(#139709549773d0eabb2048998d3a724f__a)'>
      <path
        fill='url(#139709549773d0eabb2048998d3a724f__b)'
        d='M64 128c35.346 0 64-28.654 64-64S99.346 0 64 0 0 28.654 0 64s28.654 64 64 64'
      />
      <path
        fill='url(#139709549773d0eabb2048998d3a724f__c)'
    ...
    <defs>
      <linearGradient
        id='139709549773d0eabb2048998d3a724f__b'
        x1={64}
        x2={64}
        y1={128}
        y2={0}
      ...
      <linearGradient
        id='139709549773d0eabb2048998d3a724f__c'
        x1={63.992}
        x2={64.003}
        y1={0}
        y2={128}
      ...
      <clipPath id='139709549773d0eabb2048998d3a724f__a'>
