...
const DerivLightIcEmailVerificationLinkValidIcon = (
  ...
  >
    ...
    <g clipPath='url(#fddc17cd1fdcb89190f2da15700d5a6b__a)'>
      <mask
        id='fddc17cd1fdcb89190f2da15700d5a6b__b'
        width={128}
        height={128}
        x={0}
        y={0}
      ...
      <g mask='url(#fddc17cd1fdcb89190f2da15700d5a6b__b)'>
        <path
          fill='#BBCCCE'
    ...
    <defs>
      <clipPath id='fddc17cd1fdcb89190f2da15700d5a6b__a'>
        <path fill='#fff' d='M0 0h128v128H0z' />
      </clipPath>
    </defs>
  </svg>
