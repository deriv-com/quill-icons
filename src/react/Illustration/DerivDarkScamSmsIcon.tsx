...
const DerivDarkScamSmsIcon = (
  ...
  >
    ...
    <g clipPath='url(#aa704fe9fd56dbb8098d005168367d4f__a)'>
      <mask
        id='aa704fe9fd56dbb8098d005168367d4f__b'
        width={96}
        height={96}
        x={0}
        y={0}
      ...
      <g mask='url(#aa704fe9fd56dbb8098d005168367d4f__b)'>
        <path
          fill='#414652'
    ...
    <defs>
      <clipPath id='aa704fe9fd56dbb8098d005168367d4f__a'>
