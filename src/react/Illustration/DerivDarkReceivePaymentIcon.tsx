...
const DerivDarkReceivePaymentIcon = (
  ...
  >
    ...
    <g clipPath='url(#51661b48464709efbc98f435783240a2__a)'>
      <mask
        id='51661b48464709efbc98f435783240a2__b'
        width={96}
        height={96}
        x={0}
        y={0}
      ...
      <g mask='url(#51661b48464709efbc98f435783240a2__b)'>
        <path
          fill='#9498A2'
    ...
    <defs>
      <clipPath id='51661b48464709efbc98f435783240a2__a'>
