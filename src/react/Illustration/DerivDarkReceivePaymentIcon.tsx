...
const DerivDarkReceivePaymentIcon = (
  ...
  >
    ...
    <g clipPath='url(#4f44803970bbc0128f17b01341db05e6__a)'>
      <mask
        id='4f44803970bbc0128f17b01341db05e6__b'
        width={96}
        height={96}
        x={0}
        y={0}
      ...
      <g mask='url(#4f44803970bbc0128f17b01341db05e6__b)'>
        <path
          fill='#9498A2'
    ...
    <defs>
      <clipPath id='4f44803970bbc0128f17b01341db05e6__a'>
