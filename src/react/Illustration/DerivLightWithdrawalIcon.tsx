...
const DerivLightWithdrawalIcon = (
  ...
  >
    ...
    <g clipPath='url(#6a40d88fddbc6b0769c1e9248dfc432e__a)'>
      <mask
        id='6a40d88fddbc6b0769c1e9248dfc432e__b'
        width={32}
        height={32}
        x={0}
        y={0}
      ...
      <g mask='url(#6a40d88fddbc6b0769c1e9248dfc432e__b)'>
        <path
          fill='#C7E5E5'
    ...
    <defs>
      <clipPath id='6a40d88fddbc6b0769c1e9248dfc432e__a'>
