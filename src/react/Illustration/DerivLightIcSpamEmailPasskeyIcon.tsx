...
const DerivLightIcSpamEmailPasskeyIcon = (
  ...
  >
    ...
    <g clipPath='url(#8a4df8125258a5b355113a4ddee448fe__a)'>
      <path
        fill='url(#8a4df8125258a5b355113a4ddee448fe__b)'
        fillRule='evenodd'
    ...
    <defs>
      <linearGradient
        id='8a4df8125258a5b355113a4ddee448fe__b'
        x1={16}
        x2={47.998}
        y1={47.996}
        y2={15.996}
      ...
      <clipPath id='8a4df8125258a5b355113a4ddee448fe__a'>
