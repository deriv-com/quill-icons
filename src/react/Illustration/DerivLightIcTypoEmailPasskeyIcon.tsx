...
const DerivLightIcTypoEmailPasskeyIcon = (
  ...
  >
    ...
    <g clipPath='url(#51cac054267a0a47a8d08d2a1f0b3d3a__a)'>
      <path
        fill='url(#51cac054267a0a47a8d08d2a1f0b3d3a__b)'
        fillRule='evenodd'
    ...
    <defs>
      <linearGradient
        id='51cac054267a0a47a8d08d2a1f0b3d3a__b'
        x1={16}
        x2={48}
        y1={48}
        y2={16}
      ...
      <clipPath id='51cac054267a0a47a8d08d2a1f0b3d3a__a'>
