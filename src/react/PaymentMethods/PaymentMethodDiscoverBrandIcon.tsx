...
const PaymentMethodDiscoverBrandIcon = (
  ...
  >
    ...
    />
    <path
      fill='url(#7619b7362fe7a6758e1a1373f32fceda__a)'
    ...
    />
    <path
      fill='url(#7619b7362fe7a6758e1a1373f32fceda__b)'
      d='M66.653 49.928c5.483 0 9.928-4.445 9.928-9.928s-4.445-9.928-9.928-9.928-9.927 4.445-9.927 9.928 4.444 9.928 9.927 9.928'
    />
    <path
      fill='#231F20'
    ...
    <defs>
      <linearGradient
        id='7619b7362fe7a6758e1a1373f32fceda__a'
        x1={94.297}
        x2={92.683}
        y1={47.93}
        y2={32.935}
      ...
      <linearGradient
        id='7619b7362fe7a6758e1a1373f32fceda__b'
        x1={87.742}
        x2={85.624}
        y1={47.781}
        y2={23.201}
